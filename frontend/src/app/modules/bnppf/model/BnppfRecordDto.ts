...
export class BnppfRecordDtoBuilder {
  ...
  build(): BnppfRecordDto {
    return new BnppfRecordDto(this);
  }

}

export class BnppfRecordDto {
  private _id: number;
  private _sequenceNumber: string;
  private _executionDate: Date;
  private _valueDate: Date;
  ...
  constructor(builder: BnppfRecordDtoBuilder) {
    this._id= builder.id;
